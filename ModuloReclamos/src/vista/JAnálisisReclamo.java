...
public class JAnálisisReclamo extends JFrame {
	...
	private JLabel lblAnlisisDelReclamo;
	private JTextArea txtAreaAna;
	private JTextPane txtPaneAna;
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					JAnálisisReclamo frame = new JAnálisisReclamo();
	 ...
	 * Create the frame.
	 */
	public JAnálisisReclamo() {
		setTitle("AN\u00C1LISIS DE RECLAMO");
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 580, 817);
		...
		btnNewButton.setBounds(300, 740, 110, 23);
		Consulta.add(btnNewButton);
		
		btnLimpiar = new JButton("SALIR");
		btnLimpiar.setBounds(434, 740, 110, 23);
		...
		lblAnlisisDelReclamo = new JLabel("AN\u00C1LISIS DEL RECLAMO:");
		lblAnlisisDelReclamo.setBounds(10, 587, 170, 14);
		Consulta.add(lblAnlisisDelReclamo);
		
		txtAreaAna = new JTextArea();
		txtAreaAna.setBounds(10, 606, 534, 90);
		Consulta.add(txtAreaAna);
		
		txtPaneAna = new JTextPane();
		txtPaneAna.setBounds(10, 606, 534, 90);
		Consulta.add(txtPaneAna);
		
		txtAreaFun = new JTextArea();
		txtAreaFun.setBounds(10, 446, 534, 77);
		Consulta.add(txtAreaFun);
		
		txtPaneFun = new JTextPane();
		txtPaneFun.setBounds(10, 446, 534, 77);
		Consulta.add(txtPaneFun);
		
		label = new JLabel("Dict\u00E1men Inicial");
		label.setBounds(10, 713, 86, 14);
		Consulta.add(label);
		
		comboBox_1 = new JComboBox();
		comboBox_1.setBounds(97, 709, 95, 22);
		Consulta.add(comboBox_1);
		
		label_1 = new JLabel("Responsable An\u00E1lisis");
		label_1.setBounds(230, 713, 110, 14);
		Consulta.add(label_1);
		
		textField_17 = new JTextField();
		textField_17.setEditable(false);
		textField_17.setColumns(10);
		textField_17.setBounds(335, 710, 205, 20);
		Consulta.add(textField_17);
		
		button = new JButton("GENERAR CARTA DE RESPUESTA");
		button.setBounds(10, 740, 266, 23);
		Consulta.add(button);
